...
# @raycast.title Move Window -> Top Right
# @raycast.mode silent

# Optional parameters:
# @raycast.icon assets/rectangle.inset.topright.filled.svg
# @raycast.packageName Yabai

# Documentation:
# @raycast.description Move Floating Window to Top Right of the Screen
