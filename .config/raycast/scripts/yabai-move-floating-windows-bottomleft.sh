...
# @raycast.title Move Window -> Bottom Left
# @raycast.mode silent

# Optional parameters:
# @raycast.icon assets/rectangle.inset.bottomleft.filled.svg
# @raycast.packageName Yabai

# Documentation:
# @raycast.description Move Floating Window to Bottom Left of the Screen
