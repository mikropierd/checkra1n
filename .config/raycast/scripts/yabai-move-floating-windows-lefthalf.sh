...
# @raycast.title Move Window -> Left Half
# @raycast.mode silent

# Optional parameters:
# @raycast.icon assets/rectangle.lefthalf.inset.filled.svg
# @raycast.packageName Yabai

# Documentation:
# @raycast.description Move Floating Window to Left Half of the Screen
